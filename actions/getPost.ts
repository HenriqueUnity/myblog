...
export async function getPosts() {
  ...
  const postUrl = `${process.env.GHOST_API_URL}/ghost/api/content/posts/?key=${process.env.GHOST_CONTENT_API_KEY}*include=tags,authors&order=published_at%20desc&fields=${fields}`;
